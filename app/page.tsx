...
export default function Home(){
  ...
  return <main className={phase}>
    ...
    <header><div className="logo"><i/>SEPT<span>MIN</span></div><div className="rule"><b>30</b> SEC ON <i/> <b>15</b> SEC OFF</div><div className="count">{String(idx+1).padStart(2,'0')} <span>/ 12</span></div></header>
